...
class BeamPath():
    def __init__(self, tokenizer_wrapper, max_sentence_length, sentence_tokens=[], hidden=None, prob=[], total_prob=None):
    ...
    def __deepcopy__(self, memodict={}):
        copy = BeamPath(self.tokenizer_wrapper,self.max_sentence_length, [i for i in self.sentence_tokens], self.hidden, [i for i in self.prob], self.total_prob)
        return copy
